        ...
        inputs={[
          {
            ...
            value: invoiceId || selectedFile || "ledger",
          },
        ]}
        buttons={[
          {
          ...
          },
          {
            ...
            handler: (alertData) => {
              const filename =
                alertData.pdfFilename?.trim() || invoiceId || selectedFile || "ledger";
        ...
        inputs={[
          {
            ...
            value: invoiceId || selectedFile || "ledger_data",
          },
        ]}
        buttons={[
          {
          ...
          },
          {
            ...
            handler: (alertData) => {
              const filename =
                alertData.csvFilename?.trim() || invoiceId || selectedFile || "ledger_data";
        ...
        inputs={[
          {
            ...
            type: "text",
            placeholder: "Enter PDF filename",
            value: invoiceId ? `${invoiceId}_all_sheets` : (selectedFile ? `${selectedFile}_all_sheets` : "all_ledgers"),
          },
        ]}
        buttons={[
          {
          ...
          },
          {
            text: "Download",
            handler: (alertData) => {
              const defaultName = invoiceId ? `${invoiceId}_all_sheets` : (selectedFile ? `${selectedFile}_all_sheets` : "all_ledgers");
              const filename =
