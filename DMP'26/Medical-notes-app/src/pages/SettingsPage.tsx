                        ...
                        <div className="settings-card">
                            <div className="settings-row">
                                <div className="settings-info">
                                    ...
                                    <p className="settings-card-desc">Wipe all local medical files, custom templates, and configuration settings completely.</p>
                                </div>
                                <div className="settings-action">
                                    <IonButton
                                        className="reset-btn"
                    ...
                    <div className="settings-group">
                        ...
                        <div className="settings-card" style={{ padding: '16px 20px' }}>
                            <div className="info-row">
                                ...
                                <span className="info-value">Medical Notes</span>
                            </div>
                            <div className="info-row">
