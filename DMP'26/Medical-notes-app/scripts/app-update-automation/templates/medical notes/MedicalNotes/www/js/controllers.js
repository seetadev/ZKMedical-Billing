...
.controller('OptionsCtrl', function($scope, $ionicLoading , CloudService , $http, ModalService, LocalFiles, $state, ModalService, $interval, $timeout) {
            ...
            request(messages, function(result){
                    ...
                    message.type="POST";
                    message.format = 'json';
                    message.data={action:"savecurrentfile",fname:fname,data:val1,appname:"Medical Notes"};
...
.controller('ListFilesWebCtrl', function($scope, $timeout , $ionicLoading , $interval, $state, CloudService ,$ionicHistory, $ionicActionSheet){
            ...
            CloudService.checkLogin().then(function(response){
                                           ...
                                           //logged in
                                           var files = new Array();
                                           var message ={action:"listdir",appname:"Medical Notes"};
            ...
            CloudService.checkLogin().then(function(response){
                                           ...
                                           var message ={action:"deletefile",appname:"Medical Notes",fname:file};
            ...
            var message ={action:"getfile",appname:"Medical Notes",fname:file};
...
.controller('AccountCtrl', function($scope ,$ionicModal, $timeout, $interval , CloudService) {
            ...
            var data={action:"logout",appname:"Medical Notes"};
            ...
            var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Medical Notes"};
            ...
            CloudService.request(message).then(function(response){
                                               ...
                                               var message = {action:"getInapp",appname:"Medical Notes"};
            ...
            var message={action:"register",uuid:uuid,password:pass,appname:"Medical Notes"};
...
.controller('LocalSaveWebCtrl', function($scope, CloudService, $ionicLoading){
            ...
            var message ={action:"getfile",appname:"Medical Notes",fname:filename};
