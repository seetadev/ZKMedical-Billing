...
.controller('OptionsCtrl', function($scope, $ionicLoading , CloudService , $http, ModalService, LocalFiles, $state, ModalService, $interval, $timeout) {
            ...
            request(messages, function(result){
                    ...
                    message.type="POST";
                    message.format = 'json';
                    message.data={action:"savecurrentfile",fname:fname,data:val1,appname:"Medical Requisition Form"};
...
.controller('ListFilesWebCtrl', function($scope, $timeout , $ionicLoading , $interval, $state, CloudService ,$ionicHistory, $ionicActionSheet){
            ...
            CloudService.checkLogin().then(function(response){
                                           ...
                                           //logged in
                                           var files = new Array();
                                           var message ={action:"listdir",appname:"Medical Requisition Form"};
            ...
            CloudService.checkLogin().then(function(response){
                                           ...
                                           var message ={action:"deletefile",appname:"Medical Requisition Form",fname:file};
            ...
            var message ={action:"getfile",appname:"Medical Requisition Form",fname:file};
...
.controller('AccountCtrl', function($scope ,$ionicModal, $timeout, $interval , CloudService) {
            ...
            var data={action:"logout",appname:"Medical Requisition Form"};
            ...
            var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Medical Requisition Form"};
            ...
            CloudService.request(message).then(function(response){
                                               ...
                                               var message = {action:"getInapp",appname:"Medical Requisition Form"};
            ...
            var message={action:"register",uuid:uuid,password:pass,appname:"Medical Requisition Form"};
...
.controller('PurchaseCtrl', function($scope, Items ,CloudService, $timeout ,$ionicLoading, ModalService, $interval, $ionicActionSheet) {
            ...
            var products = JSON.parse(window.localStorage.getItem("inapplocal"));
            if(item.id == "2015mlSavePrintEmail") {
            //alert("You have units remaining. Please buy when you have consumed the units");
            
            if(item.units >10) { showToast("You have "+item.units+" units remaining."); return;}
            }
...
.controller('LocalSaveWebCtrl', function($scope, CloudService, $ionicLoading){
            ...
            var message ={action:"getfile",appname:"Medical Requisition Form",fname:filename};
