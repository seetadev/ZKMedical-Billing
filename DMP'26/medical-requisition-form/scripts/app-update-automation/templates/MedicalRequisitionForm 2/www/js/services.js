...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Medical Requisition Form"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Medical Requisition Form"};
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Medical Requisition Form"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('Items',function(){
         ...
         desc = "Medical Requisition Form Web Widget";
