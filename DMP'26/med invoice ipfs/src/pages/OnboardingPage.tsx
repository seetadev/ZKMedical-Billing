                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Medical Invoice</h1>
                                <p className="step-subtitle">Generate professional medical bills and healthcare invoices entirely offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Create itemised medical bills with treatments, procedures, and medicines</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Add doctor details, patient info, and clinic branding to every invoice</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Works 100% offline — all billing data stays private on your device</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
