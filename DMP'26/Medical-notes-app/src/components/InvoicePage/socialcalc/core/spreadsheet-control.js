...
*********/
  ...
  SocialCalc.ScriptCheck = function (sheetid, coord, text) {
    ...
    if (commentstart != -1 && commentend != -1) {
      var script = text.slice(commentstart + 10, commentend);
      //alert(script);
  ...
  SocialCalc.Callbacks.ToggleCell = function (cellname) {
    ...
    if (cellinner.innerHTML.indexOf("checkmark.png") == -1) {
      // set the value to the img value
      cellinner.innerHTML =
        '<div><img src="/checkmark.png" height="15" width="15"></img></div>';
      if (cell) {
        //cell.displaystring = '<div><img src="/checkmark.png"></img></div>'    ;
        //cell.datavalue = '<div><img src="/checkmark.png"></img></div>'   ;
