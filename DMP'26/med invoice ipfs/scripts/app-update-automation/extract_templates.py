...
html_path = os.path.join(script_dir, 'templates/tab-home.html')
...
tablet_footers = [
    {"name": "Medical Invoice 1", "index": 1, "isActive": True},
    {"name": "Medical Invoice 2", "index": 2, "isActive": True},
    {"name": "Medical Invoice 3", "index": 3, "isActive": True},
    {"name": "Medical Invoice 4", "index": 4, "isActive": True},
    {"name": "Medical Invoice 5", "index": 5, "isActive": True},
    {"name": "Medical Invoice 6", "index": 6, "isActive": True}
]
