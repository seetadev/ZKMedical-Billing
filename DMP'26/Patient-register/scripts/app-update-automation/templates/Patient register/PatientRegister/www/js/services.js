...
.factory('LocalFiles', function($q){
         ...
         if(filename=="didTutorial" || filename=="customise" || filename=="choice") continue;
...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Quote Invoice"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Quote Invoice"};
                 $http({url:"http://aspiringapps.com/webapp",method:"POST",params:message}).
                 success(function(responses){
                         var results = responses.result;
                         ////alert("sencond:"+result);
                         if(results == "ok"){
                         var productList=[{"Feature": "save","Id": "2015qiCloud","Purchase":"Yes","Consumed":0,"Own":5}];
                 ...
                 var items;
                 if(result.own == 0){
                 items=[{"Feature": "save","Id": "2015qiCloud","Purchase":"No","Consumed":result.consumed,"Own":result.own}];
                 }
                 else{
                 items=[{"Feature": "save","Id": "2015qiCloud","Purchase":"Yes","Consumed":result.consumed,"Own":result.own}];
                 }
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Quote Invoice"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('App', function() {
 ...
 var footerList;
         ...
         footerList = [{
                       ...
                       index: 4,
                       name: 'Invoice Detail1'
                       }, {
                       index: 5,
                       name: 'Invoice Detail2'
                       }, {
                       index: 6,
                       name: 'Quote Type1'
                       }, {
...
.factory('Items',function(){
         ...
         productList.push({"Feature": "100Pdf","Id": "2014qi100Pdf","Purchase":"No","Consumed":0,"Own":0});
         productList.push({"Feature": "fb-tw-sms-whatsapp","Id": "2015qi10share","Purchase":"No","Consumed":0,"Own":0});
         productList.push({"Feature": "email-print-save","Id": "2016qiSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":25});
         productList.push({"Feature": "pdf-ibooks","Id": "2016qiSavePdf","Purchase":"No","Consumed":0,"Own":0});
...
.factory('ModalService',function($ionicModal, $timeout, CloudService){
         ...
         var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Quote Invoice"};
         ...
         CloudService.request(message).then(function(response){
                                            ...
                                            var message = {action:"getInapp",appname:"Quote Invoice"};
         ...
         var message={action:"register",uuid:uuid,password:pass,appname:"Quote Invoice"};
