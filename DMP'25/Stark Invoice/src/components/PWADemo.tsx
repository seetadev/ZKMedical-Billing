      ...
      <IonCardContent>
        ...
        <IonItem>
          <IonIcon 
            ...
            slot="start" 
            color={isInstalled ? "success" : isInstallable ? "primary" : "medium"}
          />
          <IonLabel>
        ...
        <div style={{ marginTop: '16px', padding: '12px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          ...
          <ol style={{ margin: '8px 0', paddingLeft: '20px' }}>
            <li><strong>Go Offline:</strong> Disconnect internet to see offline mode</li>
            <li><strong>Install App:</strong> Click install button (if available)</li>
            <li><strong>Test Storage:</strong> Click "Test Save" to save data offline</li>
            <li><strong>Test Notifications:</strong> Click "Test Notify" for push notifications</li>
          </ol>
        </div>
