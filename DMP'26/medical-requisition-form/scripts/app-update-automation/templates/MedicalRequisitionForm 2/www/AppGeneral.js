...
applicationName = "Medical Requisition Form";
...
function showPrintDialog(){
    ...
    cordova.plugins.printer.print(html, 'MedicalRequisitionForm.html', function () {
...
function exportAsCsv(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(fileSystem) {
                             ...
                             //alert("fs");
                             fileSystem.root.getFile("MedicalRequisitionForm.csv", {create: true}, function(entry) {
                                                     var fileEntry = entry;
                                                     console.log(entry);
...
function sendAttachmentCsv(content){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Medical Requisition Form',
                                                        body: content,
                                                        isHtml: true,
                                                        attachments: [
                                                                      ...
                                                                      encoding: 'UTF-8',
                                                                      data: content,
                                                                      name: 'MedicalRequisitionForm.csv'
                                                                      }],
...
item.successCallback=function(productId){
    ...
    switch(productId){
        case "2015mlSavePrintEmail":
            ...
            products[0].Own=parseInt(25)+parseInt(left);
...
function cloudInappSuccess(){
    ...
    $.ajax({
           ...
           data: {action:"purchase",appname:"Medical Requisition Form"},
           dataType: 'json',
           success: function(response) {
...
function setCloudRestoreItems(products){
    ...
    /*$.ajax({
           type: 'POST',
           url: 'http://aspiringapps.com/restore',
           data: {content:products,action:"inapp",appname:"Medical Requisition Form"},
           dataType: 'json',
           success: function(response) {
           ...
           //showToast("Please Login to access Medical Requisition Form on web");
...
function updateShareItem(){
    ...
    var itemConsumed;
    for(i in products){
        if(products[i].Id == "2014bl10share")
            itemConsumed = i;
    }
...
function checkBeforeSave(file){
    ...
    if(products[0].Purchase == "Yes"){
        ...
        navigator.notification.alert("Save as exhausted.Kindly purchase by clicking on the Purchase Tab",null,"Medical Requisition Form Widget");
...
function saveToWeb(file){
    ...
    var interval = setInterval(function(){
                               ...
                               request(messages, function(result){
                                       ...
                                       message.type="POST";
                                       message.format = 'json';
                                       message.data={action:"savefile",fname:fname,data:val1,appname:"Medical Requisition Form"};
...
function updateCloudInapp(){
    ...
    message.type="POST";
    message.format = 'json';
    message.data={action:"update",appname:"Medical Requisition Form"};
...
function showFeedback(){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Medical Requisition Form: Please share your feedback',
                                                        body: '',
                                                        isHtml: true,
                                                        onSuccess: function (winParam) {
                                                        console.log('EmailComposer onSuccess - return code ' + winParam.toString());
...
function refer(){
    ...
    var onConfirm = function(buttonIndex){
        if(buttonIndex == 4) return;
            ...
            window.plugins.socialsharing.shareViaFacebook('Medical Requisition using Medical Requisition Form', 'www/img/bi.png' /* img */, 'https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#' /* url */, function() {
                                                          console.log('share ok');
                                                          },
                                                          function(errormsg){console.log(errormsg)});
            ...
            window.plugins.socialsharing.shareViaTwitter('Medical Requisition using Medical Requisition Form','www/img/bi.png','https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#');
        }
    ...
    navigator.notification.confirm(
                                   'Refer Medical Requisition Form via', // message
                                   onConfirm,  // callback to invoke with index of button pressed
...
function updateCounter(){
    ...
    if(products[0].Purchase == "Yes") itemConsumed =0;
...
function checkBeforeUse(feature,name){
    ...
    if(products[0].Purchase == "Yes") itemAvailable =0;
    else{
        navigator.notification.alert("Kindly go to Purchase tab and buy 25 times Save as, Print and Email to continue ",null, "Save as,Print and Email");
        return;
    }
    ...
    if(feature == "email"){
        ...
        cordova.require('emailcomposer.EmailComposer').show({
                                                            ...
                                                            cc: '',
                                                            bcc: '',
                                                            subject: 'Medical Requisition Form Workbook',
                                                            body: content,
                                                            isHtml: true,
                                                            attachments: [{
                                                                          mimeType: 'text/html',
                                                                          encoding: 'UTF-8',
                                                                          data: content,
                                                                          name: 'MedicalRequisitionForm.html'
                                                                          }],
