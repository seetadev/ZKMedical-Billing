...
const InvoiceForm: React.FC<InvoiceFormProps> = ({ isOpen, onClose }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      showToastMessage("Medical record saved successfully!", "success");
      ...
      setToastMessage("Failed to save receipt data. Please try again.");
  ...
  const handleClear = async () => {
    try {
      ...
      showToastMessage("Receipt data cleared successfully!", "success");
    } catch (error) {
      setToastMessage("Failed to clear receipt data");
      setToastColor("danger");
      setShowToast(true);
    }
  };
      ...
      >
        <IonHeader>
          <IonToolbar color="primary">
            <IonTitle>Receipt Entry Form</IonTitle>
            <IonButtons slot="end">
        ...
        <IonContent className="invoice-form-content">
          <IonGrid>
            ...
            <IonCard>
              <IonCardHeader>
                <IonCardTitle>Receipt Information</IonCardTitle>
              </IonCardHeader>
              <IonCardContent>
                <IonList>
                  <IonItem>
