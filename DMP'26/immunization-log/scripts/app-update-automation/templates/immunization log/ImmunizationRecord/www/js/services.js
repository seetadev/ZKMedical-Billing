...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Immunization Record"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Immunization Record"};
                 $http({url:"http://aspiringapps.com/webapp",method:"POST",params:message}).
                 success(function(responses){
                         var results = responses.result;
                         ////alert("sencond:"+result);
                         if(results == "ok"){
                         var productList=[{"Feature": "save","Id": "2017imrCloud","Purchase":"Yes","Consumed":0,"Own":5}];
                 ...
                 var items;
                 if(result.own == 0){
                 items=[{"Feature": "save","Id": "2017imrCloud","Purchase":"No","Consumed":result.consumed,"Own":result.own}];
                 }
                 else{
                 items=[{"Feature": "save","Id": "2017imrCloud","Purchase":"Yes","Consumed":result.consumed,"Own":result.own}];
                 }
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Immunization Record"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('ModalService',function($ionicModal, $timeout, CloudService){
         ...
         var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Immunization Record"};
         ...
         CloudService.request(message).then(function(response){
                                            ...
                                            var message = {action:"getInapp",appname:"Immunization Record"};
         ...
         var message={action:"register",uuid:uuid,password:pass,appname:"Immunization Record"};
...
.factory('MoreAppService', function(){
         ...
         appbundles = [{name: 'Business Suite', desc: 'Get a comprehensive view of your business',
                       ...
                       {name: 'Immunization Record Suite', desc: 'Managing your finances and do financial book keeping',
