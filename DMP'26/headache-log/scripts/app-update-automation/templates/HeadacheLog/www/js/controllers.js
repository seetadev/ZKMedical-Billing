...
.controller('OptionsCtrl', function($scope, $ionicLoading , CloudService , $http, $state, ModalService, $interval, LocalFiles, $timeout) {
   ...
   // save and save as starts here
            ...
            request(messages, function(result){
                    ...
                    message.type="POST";
                    message.format = 'json';
                    message.data={action:"savecurrentfile",fname:fname,data:val1,appname:"Headache Log"};
...
.controller('ListFilesWebCtrl', function($scope, $timeout , $ionicLoading , $interval, $state, CloudService ,$ionicHistory, $ionicActionSheet){
            ...
            CloudService.checkLogin().then(function(response){
                   ...
                   //logged in
                   var files = new Array();
                   var message ={action:"listdir",appname:"Headache Log"};
            ...
            CloudService.checkLogin().then(function(response){
               ...
               var message ={action:"deletefile",appname:"Headache Log",fname:file};
            ...
            var message ={action:"getfile",appname:"Headache Log",fname:file};
...
var data={action:"logout",appname:"Headache Log"};
...
.controller('PurchaseCtrl', function($scope, Items ,CloudService, $timeout ,$ionicLoading, $interval, ModalService, $ionicActionSheet) {
   ...
   //alert(JSON.stringify($scope.items));
    ...
    if(item == "save"){
        ...
        for(i in products){
        if(products[i].Id == "2016hcl10share") continue;
    ...
    $scope.purchasePDF = function(id){
        ...
        if(id == "2016hcl10Pdf" || id == "2016hcl25Pdf" || id == "2016hcl50Pdf" || id == "2016hcl100Pdf"){
            for(var i=0;i<4;i++){
        ...
        else if(id == "2016hcl10share"){
            if(products[4].Purchase == "Yes")
            return;
        }
        else if(id == "2016hclCloud"){
        ...
        else if(id == "2016hclSavePrintEmail"){
        ...
        else if(id == "2016hcl500SavePrintEmail"){
        ...
        else if(id == "2016hcl1000SavePrintEmail"){
...
.controller('LocalSaveWebCtrl', function($scope, CloudService, $ionicLoading){
            ...
            var message ={action:"getfile",appname:"Headache Log",fname:filename};
