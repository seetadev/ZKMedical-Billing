    ...
    */
    ...
    SocialCalc.RenderCell = function (
        ...
        if (context.cellskip[coord]) {
            ...
            result = noElement
                ...
                : document.createElement("td"); // span start is scrolled away, so make a special cell
    ...
    SocialCalc.ProcessTouchMove = function (event) {
        ...
        if (touchinfo.move_start == 0) {
            ...
            if (
                touchinfo.move_start - touchinfo.touch_start >
                touchinfo.ranging_threshold
            ) {
                ...
                var mouseDn = SocialCalc.TouchGetSimulatedMouseEvent(
                    event,
                    "mousedown"
                );
    ...
    SocialCalc.ProcessTouchEnd = function (e) {
        ...
        if (touchinfo.ranging) {
            ...
            if (delta < touchinfo.doubletap_threshold && delta > 0) {
                ...
                touchinfo.timeout_handle = setTimeout(
                    timeoutFn(),
                    touchinfo.doubletap_threshold
                );
            }
            touchinfo.last_touch = now;
        }
    ...
    SocialCalc.EditorProcessSwipe = function (
        event,
        touchinfo,
        wobj,
        swipevert,
    ...
    SocialCalc.EditorProcessDoubleTap = function (event, touchinfo, wobj) {
        ...
        var mouseDblClick = SocialCalc.TouchGetSimulatedMouseEvent(
            event,
            "dblclick"
        );
