                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Immunization Log</h1>
                                <p className="step-subtitle">Keep track of your family's vaccination records and upcoming doses offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Track vaccination schedules for your whole family</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Manage next dose dates and medical notes securely</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Works 100% offline, keeping health records private</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
