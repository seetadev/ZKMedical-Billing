  ...
  const renderFileList = async () => {
    ...
    try {
      ...
      if (filteredFiles.length === 0) {
        const title = searchQuery.trim() ? "No search results" : "No saved invoices";
                ...
                return (
                  ...
                  >
                    <div className="card-top-row">
                      <div className="invoice-badge-id">
                        <IonIcon icon={documentTextOutline} className="id-icon" />
                        <span className="id-text">{meta.invoiceId}</span>
                      </div>
                      {meta.amount && meta.amount !== '-' ? (
                        <div className="invoice-amount-badge">
                          {meta.amount}
                        </div>
                      ) : null}
                    </div>
                    ...
                    <div className="card-details-row">
                      <div className="patient-info">
                        ...
                        <span className="patient-name">
                          {meta.customer && meta.customer !== '-' ? meta.customer : 'Walk-in Patient'}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="card-meta-row">
                      ...
                      {meta.itemsCount > 0 && (
                        <div className="meta-item">
                          <IonIcon icon={listOutline} className="meta-icon" />
                          <span>{meta.itemsCount} {meta.itemsCount === 1 ? 'item' : 'items'}</span>
                        </div>
                      )}
                    </div>
      ...
      <div className="files-page-wrapper">
        <div className="files-controls-row">
          ...
          <div className="sort-select-wrapper">
            <IonIcon icon={swapVerticalOutline} className="sort-icon" />
            <IonSelect
              value={sortBy}
              placeholder="Sort by"
              ...
              interface="popover"
            >
              <IonSelectOption value="dateModified">Recent Modified</IonSelectOption>
              <IonSelectOption value="dateCreated">Date Created</IonSelectOption>
              <IonSelectOption value="name">Alphabetical</IonSelectOption>
            </IonSelect>
          </div>
        </div>

        <div className="files-scrollable-container">
          {fileListContent}
        </div>
      </div>
