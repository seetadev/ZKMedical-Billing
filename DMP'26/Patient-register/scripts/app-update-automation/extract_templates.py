...
html_path = os.path.join(script_dir, 'templates/Patient register/tab-home.html')
...
pr_footers = [
    {"name": "Register 1", "index": 1, "isActive": True},
    {"name": "Register 2", "index": 2, "isActive": False},
    {"name": "Register 3", "index": 3, "isActive": False},
    {"name": "Register 4", "index": 4, "isActive": False}
]
