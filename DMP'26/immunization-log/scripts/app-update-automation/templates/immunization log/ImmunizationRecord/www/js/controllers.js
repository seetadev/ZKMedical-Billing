...
.controller('OptionsCtrl', function($scope, $ionicLoading , CloudService , $http, $state, ModalService, $interval, LocalFiles, $timeout) {
   ...
   // save and save as starts here
            ...
            request(messages, function(result){
                    ...
                    message.type="POST";
                    message.format = 'json';
                    message.data={action:"savecurrentfile",fname:fname,data:val1,appname:"Immunization Record"};
...
.controller('ListFilesWebCtrl', function($scope, $timeout , $ionicLoading , $interval, $state, CloudService ,$ionicHistory, $ionicActionSheet){
            ...
            CloudService.checkLogin().then(function(response){
                   ...
                   //logged in
                   var files = new Array();
                   var message ={action:"listdir",appname:"Immunization Record"};
            ...
            CloudService.checkLogin().then(function(response){
               ...
               var message ={action:"deletefile",appname:"Immunization Record",fname:file};
            ...
            var message ={action:"getfile",appname:"Immunization Record",fname:file};
...
var data={action:"logout",appname:"Immunization Record"};
...
.controller('PurchaseCtrl', function($scope, Items ,CloudService, $timeout ,$ionicLoading, $interval, ModalService, $ionicActionSheet) {
   ...
   //alert(JSON.stringify($scope.items));
    ...
    if(item == "save"){
        ...
        for(i in products){
        if(products[i].Id == "2017imr10share") continue;
    ...
    $scope.purchasePDF = function(id){
        ...
        if(id == "2017imr10Pdf" || id == "2017imr25Pdf" || id == "2017imr50Pdf" || id == "2017imr100Pdf"){
            for(var i=0;i<4;i++){
        ...
        else if(id == "2017imr10share"){
            if(products[4].Purchase == "Yes")
            return;
        }
        else if(id == "2017imrCloud"){
        ...
        else if(id == "2017imrSavePrintEmail"){
        ...
        else if(id == "2017imr500SavePrintEmail"){
        ...
        else if(id == "2017imr1000SavePrintEmail"){
...
.controller('LocalSaveWebCtrl', function($scope, CloudService, $ionicLoading){
            ...
            var message ={action:"getfile",appname:"Immunization Record",fname:filename};
