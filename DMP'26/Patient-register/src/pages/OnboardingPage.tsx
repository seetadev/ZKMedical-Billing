                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Patient Register</h1>
                                <p className="step-subtitle">Manage patient sign-ins, check-ins, and visitor logs offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Track patient sign-in records and visit details offline</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Record departments, doctors, and patient details securely</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Generate professional PDF report summaries and share instantly</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
