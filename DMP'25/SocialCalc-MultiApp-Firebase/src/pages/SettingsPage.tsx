...
import { clearFirebaseTemplatesFromLocalStorage } from "../firebase/templateService";
...
const SettingsPage: React.FC = () => {
  ...
  const handleClearFirebaseTemplates = () => {
    try {
      clearFirebaseTemplatesFromLocalStorage();
      setToastMessage("Downloaded Firebase templates cleared successfully");
      setShowToast(true);
    } catch (error) {
      console.error("Error clearing Firebase templates:", error);
      setToastMessage("Failed to clear Firebase templates");
      setShowToast(true);
    }
  };
  ...
  return (
    ...
    >
            ...
            >
              ...
              <IonCardContent>
                <IonList>
                  ...
                  <IonItem button onClick={handleClearFirebaseTemplates}>
                    <IonIcon icon={cloudOutline} slot="start" />
                    <IonLabel>
                      <h3>Clear Downloaded Templates</h3>
                      <p>Remove cached Firebase templates from local storage</p>
                    </IonLabel>
                  </IonItem>
                </IonList>
              </IonCardContent>
            ...
            >
              <IonCardHeader
                className={
                  isDarkMode
                    ...
                    : "auth-card-header-light"
                }
              >
                <IonCardTitle
                  className={
                    isDarkMode
                      ? "auth-card-title-dark"
                      : "auth-card-title-light"
                  }
                >
                  <IonIcon
              ...
              <IonCardContent>
                <IonList>
                  ...
                  >
                    <IonIcon
                      icon={isAuthenticated ? personAdd : logIn}
                      slot="start"
                      style={{
                        color: isAuthenticated ? "#28ba62" : "#3880ff",
                      }}
                    />
                    <IonLabel>
                      <h3>
                      ...
                      <p>
                        {isAuthenticated
                          ...
                          : "Sign in to sync files to cloud storage"}
                      </p>
                    </IonLabel>
                  </IonItem>
                </IonList>
      ...
      <FirebaseAuth
        ...
        onDidDismiss={() => setShowFirebaseAuthModal(false)}
      />
    </IonPage>
  );
};
