...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Medical Notes"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Medical Notes"};
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Medical Notes"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('App', function() {
         ...
         footerList = [{
                       index: 1,
                       name: 'Medical Notes 1'
                       }, {
                       index: 2,
                       name: 'Medical Notes 2'
                       },{
                       index: 3,
                       name: 'Medical Notes 3'
                       },{
                       index: 4,
                       name: 'Medical Notes 4'
                       },{
                       index: 5,
                       name: 'Medical Notes 5'
                       },{
                       index: 6,
                       name: 'Medical Notes 6'
                       }];
         }
