...
(function (root, factory) {
  ...
  */
    ...
    SocialCalc.Popup.Types.List.Create = function (type, id, attribs) {
        ...
        ele.innerHTML =
            '<input style="cursor:pointer;width:' +
            (spcdata.attribs.inputWidth || "100px") +
            ';font-size:smaller;" onfocus="this.blur();" onclick="SocialCalc.Popup.CClick(\'' +
            id +
            '\');" value="">';
    ...
    SocialCalc.Popup.Types.List.Show = function (type, id) {
        ...
        if (spcdata.custom) {
            ...
            ele.innerHTML =
                '<div style="cursor:default;padding:4px;background-color:#CCC;">' +
                str +
                "</div>";
            ...
            ele = document.createElement("div");
            ele.innerHTML =
                '<div style="cursor:default;padding:4px;">' + str + "</div>";
    ...
    SocialCalc.Popup.Types.ColorChooser.SetColors = function (id) {
            ...
            for (col = 0; col < 5; col++) {
                ...
                if (grid["selectedrow" + col] == row) {
                    g.ele.style.backgroundImage =
                        "url(" + sp.imagePrefix + "chooserarrow.gif)";
                } else {
                    g.ele.style.backgroundImage = "";
                }
            }
        ...
        if (!spcdata.value) {
            ...
            grid.msg.style.backgroundImage =
                "url(" + sp.imagePrefix + "defaultcolor.gif)";
    ...
    SocialCalc.Popup.Types.ColorChooser.CustomToGrid = function (id) {
        ...
        oele = spcdata.contentele;
        mainele = SocialCalc.Popup.Types.ColorChooser.CreateGrid(
            "ColorChooser",
            id
        );
        nele = document.createElement("div");
