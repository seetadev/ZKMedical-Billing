...
# Set up environment variables (for Firebase features)
cp .env.sample .env
...
- Cloud storage with [Firebase](https://firebase.google.com/)

## 📚 Documentation

- [Firebase Setup Guide](FIREBASE_SETUP.md) - Complete Firebase configuration instructions
- [Environment Variables Setup](ENVIRONMENT_SETUP.md) - Environment configuration guide
