...
applicationName = "Immunization Record";
...
function showPrintDialog(){
    ...
    cordova.plugins.printer.print(html, 'ImmunizationRecord.html', function () {
...
function exportAsCsv(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(fileSystem) {
                             ...
                             //alert("fs");
                             fileSystem.root.getFile("ImmunizationRecord.csv", {create: true}, function(entry) {
                                                     var fileEntry = entry;
                                                     console.log(entry);
...
item.init=function(){
    ...
    $.ajax({
           ...
           var productList=[];
           productList.push({"Feature": "10Pdf","Id": "2017imr10Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "25Pdf","Id": "2017imr25Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "50Pdf","Id": "2017imr50Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "100Pdf","Id": "2017imr100Pdf","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "fb-tw-sms-whatsapp","Id": "2017imr10share","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "email-print-save","Id": "2017imrSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":5});
           productList.push({"Feature": "pdf-ibooks","Id": "2017imrSavePdf","Purchase":"No","Consumed":0,"Own":0})
           productList.push({"Feature": "email-second-print-save","Id": "2017imr500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});/*** 500 & 1000 times Save as, Print and Email ***/
           productList.push({"Feature": "email-third-print-save","Id": "2017imr1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
...
var IAP = {
list: [ "2017imr10Pdf", "2017imr25Pdf", "2017imr50Pdf","2017imr100Pdf","2017imr10share" ,"2017imrCloud", "2017imrSavePrintEmail" , "2017imrSavePdf" , "2017imr500SavePrintEmail", "2017imr1000SavePrintEmail"]
};
...
item.getAllProducts=function(){
    ...
    var renderIAPs = function (el) {
        if (IAP.loaded) {
            //alert(IAP.loaded);
            var coins10  = IAP.products["2017imr10Pdf"];
            var coins100 = IAP.products["2017imr25Pdf"];
            var coins1000 = IAP.products["2017imr50Pdf"];
            var coins10000 = IAP.products["2017imr100Pdf"];
...
item.successCallback=function(productId){
    ...
    switch(productId){
        ...
        case "2017imrSavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            ...
            break;
        case "2017imr500SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            ...
            break;
        case "2017imr1000SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            if(products[5].Purchase == "Yes"){
                left = parseInt(products[5].Own) - parseInt(products[5].Consumed);
                products[5].Consumed = 0;
...
function cloudInappSuccess(){
    ...
    $.ajax({
           ...
           data: {action:"purchase",appname:"Immunization Record"},
           dataType: 'json',
           success: function(response) {
...
function setCloudRestoreItems(products){
    ...
    $.ajax({
           type: 'POST',
           url: 'http://aspiringapps.com/restore',
           data: {content:products,action:"inapp",appname:"Immunization Record"},
           dataType: 'json',
           success: function(response) {
           ...
           window.setTimeout(function(){
                ...
                //showToast("Please Login to access Immunization Record on web");
...
function updateShareItem(){
    ...
    var itemConsumed;
    for(i in products){
        if(products[i].Id == "2017imr10share")
            itemConsumed = i;
    }
...
function saveToWeb(file){
    ...
    var interval = setInterval(function(){
                               ...
                               request(messages, function(result){
                                       ...
                                       message.type="POST";
                                       message.format = 'json';
                                       message.data={action:"savefile",fname:fname,data:val1,appname:"Immunization Record"};
...
function updateCloudInapp(){
    ...
    message.type="POST";
    message.format = 'json';
    message.data={action:"update",appname:"Immunization Record"};
...
function showFeedback(){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Immunization Record: Please share your feedback',
                                                        body: '',
                                                        isHtml: true,
                                                        onSuccess: function (winParam) {
                                                        console.log('EmailComposer onSuccess - return code ' + winParam.toString());
...
function refer(){
    ...
    var onConfirm = function(buttonIndex){
        if(buttonIndex == 4) return;
            ...
            window.plugins.socialsharing.shareViaFacebook('Manage finance for your business using Immunization Record', 'www/img/bi.png' /* img */, 'https://itunes.apple.com/us/app/business-ledger-pro/id515667725?ls=1&mt=8' /* url */, function() {
                                                          console.log('share ok');
                                                          },
                                                          function(errormsg){console.log(errormsg)});
            ...
            window.plugins.socialsharing.shareViaTwitter('Manage finance for your business using Immunization Record','www/img/bi.png','https://itunes.apple.com/us/app/business-ledger-pro/id515667725?ls=1&mt=8');
        }
    ...
    navigator.notification.confirm(
                                   'Refer Immunization Record via', // message
                                   onConfirm,  // callback to invoke with index of button pressed
...
function saveToDropbox(val){
    ...
    var checksuccess = function() {
        ...
        $.ajax({
               ...
               pdf_name = "ImmunizationRecord"+identifier;
               }
               else{
...
function savePDF(){
    ...
    window.html2pdf.create(
                           ""+content+"",
                           "~/Documents/ImmunizationRecord.pdf", // on iOS,
...
function checkBeforeUse(feature,name){
    ...
    if(feature == "email"){
        ...
        cordova.require('emailcomposer.EmailComposer').show({
                                                            ...
                                                            cc: '',
                                                            bcc: '',
                                                            subject: 'Immunization Record Workbook',
                                                            body: content,
                                                            isHtml: true,
                                                            attachments: [{
                                                                          mimeType: 'text/html',
...
document.addEventListener("deviceready", function(){
                          ...
                          for(i in products){
                          if(products[i].Id == "2017imrSavePrintEmail"){
                          console.log("saveEmail present");
                          saveEmail=true;
                          }
                          if(products[i].Id == "2017imrSavePdf"){
                          console.log("savePdf present");
                          savePdf=true;
                          }
                          if(products[i].Id == "2017imr500SavePrintEmail"){
                          console.log("secondSaveEmail present");
                          secondSaveEmail=true;
                          }
                          if(products[i].Id == "2017imr1000SavePrintEmail"){
                          ...
                          if(!saveEmail){
                          products.push({"Feature": "email-print-save","Id": "2017imrSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":10});
                          ...
                          if(!savePdf){
                          products.push({"Feature": "pdf-ibooks","Id": "2017imrSavePdf","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!secondSaveEmail){
                          products.push({"Feature": "email-second-print-save","Id": "2017imr500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!thirdSaveEmail){
                          products.push({"Feature": "email-third-print-save","Id": "2017imr1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
