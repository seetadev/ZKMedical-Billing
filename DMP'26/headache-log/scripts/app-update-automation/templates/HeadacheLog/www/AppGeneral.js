...
function showPrintDialog(){
    ...
    cordova.plugins.printer.print(html, 'HeadacheLog.html', function () {
...
function exportAsCsv(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(fileSystem) {
                             ...
                             //alert("fs");
                             fileSystem.root.getFile("HeadacheLog.csv", {create: true}, function(entry) {
                                                     var fileEntry = entry;
                                                     console.log(entry);
...
item.init=function(){
    ...
    $.ajax({
           ...
           var productList=[];
           productList.push({"Feature": "10Pdf","Id": "2016hcl10Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "25Pdf","Id": "2016hcl25Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "50Pdf","Id": "2016hcl50Pdf","Purchase":"No","Consumed":0,"Own":0 });
           productList.push({"Feature": "100Pdf","Id": "2016hcl100Pdf","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "fb-tw-sms-whatsapp","Id": "2016hcl10share","Purchase":"No","Consumed":0,"Own":0});
           productList.push({"Feature": "email-print-save","Id": "2016hclSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":5});
           productList.push({"Feature": "pdf-ibooks","Id": "2016hclSavePdf","Purchase":"No","Consumed":0,"Own":0})
           productList.push({"Feature": "email-second-print-save","Id": "2016hcl500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});/*** 500 & 1000 times Save as, Print and Email ***/
           productList.push({"Feature": "email-third-print-save","Id": "2016hcl1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
...
var IAP = {
list: [ "2016hcl10Pdf", "2016hcl25Pdf", "2016hcl50Pdf","2016hcl100Pdf","2016hcl10share" ,"2016hclCloud" , "2016hclSavePrintEmail" , "2016hclSavePdf" , "2016hcl500SavePrintEmail", "2016hcl1000SavePrintEmail" ]
};
...
item.getAllProducts=function(){
    ...
    var renderIAPs = function (el) {
        if (IAP.loaded) {
            //alert(IAP.loaded);
            var coins10  = IAP.products["2016hcl10Pdf"];
            var coins100 = IAP.products["2016hcl25Pdf"];
            var coins1000 = IAP.products["2016hcl50Pdf"];
            var coins10000 = IAP.products["2016hcl100Pdf"];
...
item.successCallback=function(productId){
    ...
    switch(productId){
        ...
        case "2016hclSavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            ...
            products[5].Own=parseInt(20)+parseInt(left);
            ...
            break;
        case "2016hcl500SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            ...
            left = parseInt(left) + parseInt(products[7].Own) - parseInt(products[7].Consumed);
            console.log("left from previous purchase: "+left);
            products[7].Own=parseInt(1000)+parseInt(left);
            console.log("owned now: "+products[7].Own);
            products[7].Consumed = 0;
            
            break;
        case "2016hcl1000SavePrintEmail":  /*** 500 & 1000 times Save as, Print and Email ***/
            var left = 0;
            if(products[5].Purchase == "Yes"){
                left = parseInt(products[5].Own) - parseInt(products[5].Consumed);
                products[5].Consumed = 0;
            ...
            left = parseInt(left) + parseInt(products[8].Own) - parseInt(products[8].Consumed);
            console.log("left from previous purchase: "+left);
            products[8].Own=parseInt(2000)+parseInt(left);
        ...
        case "2016hclSavePdf":
            ...
            console.log("left from previous purchase: "+left);
            products[6].Own=parseInt(20)+parseInt(left);
...
function cloudInappSuccess(){
    ...
    $.ajax({
           ...
           data: {action:"purchase",appname:"Headache Log"},
           dataType: 'json',
           success: function(response) {
...
function setCloudRestoreItems(products){
    ...
    $.ajax({
           type: 'POST',
           url: 'http://aspiringapps.com/restore',
           data: {content:products,action:"inapp",appname:"Headache Log"},
           dataType: 'json',
           success: function(response) {
           ...
           window.setTimeout(function(){
                ...
                //showToast("Please Login to access Headache Log on web");
...
function updateShareItem(){
    ...
    var itemConsumed;
    for(i in products){
        if(products[i].Id == "2016hcl10share")
            itemConsumed = i;
    }
...
function saveToWeb(file){
    ...
    var interval = setInterval(function(){
                               ...
                               request(messages, function(result){
                                       ...
                                       message.type="POST";
                                       message.format = 'json';
                                       message.data={action:"savefile",fname:fname,data:val1,appname:"Headache Log"};
...
function updateCloudInapp(){
    ...
    message.type="POST";
    message.format = 'json';
    message.data={action:"update",appname:"Headache Log"};
...
function showFeedback(){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Headache Log: Please share your feedback',
                                                        body: '',
                                                        isHtml: true,
                                                        onSuccess: function (winParam) {
                                                        console.log('EmailComposer onSuccess - return code ' + winParam.toString());
...
function refer(){
    ...
    var onConfirm = function(buttonIndex){
        if(buttonIndex == 4) return;
            ...
            window.plugins.socialsharing.shareViaFacebook('Manage finance for your business using Headache Log', 'www/img/bi.png' /* img */, 'https://itunes.apple.com/us/app/business-ledger-pro/id515667725?ls=1&mt=8' /* url */, function() {
                                                          console.log('share ok');
                                                          },
                                                          function(errormsg){console.log(errormsg)});
            ...
            window.plugins.socialsharing.shareViaTwitter('Manage finance for your business using Headache Log','www/img/bi.png','https://itunes.apple.com/us/app/business-ledger-pro/id515667725?ls=1&mt=8');
        }
    ...
    navigator.notification.confirm(
                                   'Refer Headache Log via', // message
                                   onConfirm,  // callback to invoke with index of button pressed
...
function saveToDropbox(val){
    ...
    var checksuccess = function() {
        ...
        $.ajax({
               ...
               pdf_name = "HeadacheLog"+identifier;
               }
               else{
...
function savePDF(){
    ...
    window.html2pdf.create(
                           ""+content+"",
                           "~/Documents/HeadacheLog.pdf", // on iOS,
...
document.addEventListener("deviceready", function(){
                          ...
                          for(i in products){
                          if(products[i].Id == "2016hclSavePrintEmail"){
                          console.log("saveEmail present");
                          saveEmail=true;
                          }
                          if(products[i].Id == "2016hclSavePdf"){
                          console.log("savePdf present");
                          savePdf=true;
                          }
                          if(products[i].Id == "2016hcl500SavePrintEmail"){
                          console.log("secondSaveEmail present");
                          secondSaveEmail=true;
                          }
                          if(products[i].Id == "2016hcl1000SavePrintEmail"){
                          ...
                          if(!saveEmail){
                          products.push({"Feature": "email-print-save","Id": "2016hclSavePrintEmail","Purchase":"Yes","Consumed":0,"Own":5});
                          ...
                          if(!savePdf){
                          products.push({"Feature": "pdf-ibooks","Id": "2016hclSavePdf","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!secondSaveEmail){
                          products.push({"Feature": "email-second-print-save","Id": "2016hcl500SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
                          ...
                          if(!thirdSaveEmail){
                          products.push({"Feature": "email-third-print-save","Id": "2016hcl1000SavePrintEmail","Purchase":"No","Consumed":0,"Own":0});
                          console.log("new "+JSON.stringify(products));
                          window.localStorage.setItem("inapplocal",  JSON.stringify(products));
                          setCloudRestoreItems(JSON.stringify(products));
                          }
